...
const BLOCKED_DOMAINS = new Set([
  ...
  'news.ycombinator.com', 'hackernews.com', 'quora.com',
...
const ARTICLE_SIGNALS  = ['in this article', 'in this post', 'subscribe to our newsletter', 'read more', 'published by', 'last updated'];
const ECOMMERCE_SIGNALS = ['add to cart', 'add to bag', 'free shipping', 'in stock', 'out of stock', 'buy now', 'shop now', 'order now', 'ships in'];
