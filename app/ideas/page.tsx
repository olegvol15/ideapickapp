...
import { useGetSavedIdeas } from '@/hooks/use-saved-ideas';
...
export default function IdeasPage() {
  ...
  const { data: savedIdeas = [], isLoading: ideasLoading } = useGetSavedIdeas(
    user?.id
  );

  const workspaceLoading = loading || (Boolean(user) && ideasLoading);
