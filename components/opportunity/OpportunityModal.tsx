...
export function OpportunityModal({ idea, onClose }: OpportunityModalProps) {
  ...
  // Idea may be null while AnimatePresence is animating out — always derive from displayIdea
              ...
              <div className="px-6 pb-6 space-y-5">
                ...
                <Section title="Market Intelligence">
                  <div className="grid grid-cols-3 gap-3">
                    <div className="rounded-lg p-3" style={{ border: "1px solid var(--border-soft)", backgroundColor: "var(--bg-subtle)" }}>
                      <p className="text-[9px] font-bold uppercase tracking-widest mb-1" style={{ color: "var(--text-4)" }}>Demand</p>
                      <p className={`text-sm font-bold ${SIGNAL_COLOR[i.marketDemand]}`}>{i.marketDemand}</p>
                    </div>
                    <div className="rounded-lg p-3" style={{ border: "1px solid var(--border-soft)", backgroundColor: "var(--bg-subtle)" }}>
                      <p className="text-[9px] font-bold uppercase tracking-widest mb-1" style={{ color: "var(--text-4)" }}>Competition</p>
                      <p className={`text-sm font-bold ${COMPETITION_COLOR[i.competitionLevel]}`}>{i.competitionLevel}</p>
                    </div>
                    <div className="rounded-lg p-3" style={{ border: "1px solid var(--border-soft)", backgroundColor: "var(--bg-subtle)" }}>
                      <p className="text-[9px] font-bold uppercase tracking-widest mb-1" style={{ color: "var(--text-4)" }}>Monetization</p>
                      <p className={`text-sm font-bold ${SIGNAL_COLOR[i.monetizationPotential]}`}>{i.monetizationPotential}</p>
                    </div>
                  </div>
                </Section>
                ...
                <Section title="Build Planning">
                  <button
                    ...
                    className="w-full flex items-center justify-between gap-3 rounded-xl px-5 py-4 text-left transition-colors group"
