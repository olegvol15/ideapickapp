                  ...
                  <div className="p-6 pb-5">
                    <div className="flex items-start justify-between gap-4 mb-3">
                      <div className="flex flex-wrap items-center gap-2">
                        <Badge
                          variant={
                            DIFFICULTY_VARIANT[i.difficulty] as Parameters<
                              typeof Badge
                            >[0]['variant']
                          }
                        >
                      ...
                      <div className="grid grid-cols-3 gap-3">
                        {(
                          [
                            {
                              label: 'Demand',
                              value: i.marketDemand,
                              cls: SIGNAL_COLOR[i.marketDemand],
                            },
                            {
                              label: 'Competition',
                              value: i.competitionLevel,
                              cls: COMPETITION_COLOR[i.competitionLevel],
                            },
                            {
                              label: 'Monetization',
                              value: i.monetizationPotential,
                              cls: SIGNAL_COLOR[i.monetizationPotential],
                            },
                          ] as const
                        ).map(({ label, value, cls }) => (
                          <div
                          ...
                          >
                            ...
                            <p className={cn('text-sm font-bold', cls)}>
                              {value}
                            </p>
                          </div>
                        ))}
