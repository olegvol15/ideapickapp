...
import { OpportunityGapBlock } from './OpportunityGapBlock';
import { SectionHeading } from './SectionHeading';
import { normalizeCompetitorBullets } from '@/lib/validate/legacy';
import type { CompetitorInsight, OpportunityGap } from '@/lib/schemas';
...
export function CompetitorsSection({
  ...
  return (
    <div className="flex flex-col gap-6">
      {opportunityGap && <OpportunityGapBlock gap={opportunityGap} />}
