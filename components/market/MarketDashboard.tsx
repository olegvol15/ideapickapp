    ...
    <div className="space-y-4">
      ...
      >
        ...
        <div className="grid grid-cols-3 gap-2.5 mt-4">
          ...
          <StatBox
            label="Competition"
            value={marketCondition.split(' ')[0]}
            sub={`${competitorsFound} found`}
          />
        </div>
      </div>
        ...
        >
          ...
          <ul className="space-y-2">
            {mainPatterns.map((p, i) => (
              ...
              >
                <span
                  className="mt-[5px] h-[4px] w-[4px] shrink-0 rounded-full"
                  style={{ backgroundColor: 'var(--border)' }}
                />
                {p}
              </li>
        ...
        >
          ...
          <dl className="space-y-1.5">
            <div className="flex gap-3">
              <dt
                className="w-20 shrink-0 text-[9px] font-bold uppercase tracking-widest pt-[1px]"
                style={{ color: 'var(--text-4)' }}
              >
                Currently
              </dt>
